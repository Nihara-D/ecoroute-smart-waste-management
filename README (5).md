...
> IT4020 Modern Topics in IT | SLIIT | Year 4 Semester 1/2 | 2026
...
|---------|-----------|-----------------|
| 🗑️ Bin Management | http://localhost:3001/api-docs | http://localhost:3000/bin/api-docs |
...
The API Gateway runs on **port 3000** and routes all requests to the correct microservice — no need to remember individual ports.
...
│       └── models/dispatchStore.js
├── citizen-service/
│   └── src/
│       ├── index.js
│       ├── routes/citizenRoutes.js
│       ├── controllers/citizenController.js
│       └── models/citizenStore.js
├── ewaste-service/
│   └── src/
│       ├── index.js
│       ├── routes/ewasteRoutes.js
│       ├── controllers/ewasteController.js
│       └── models/ewasteStore.js
├── README.md
├── README.html        ← Open locally for animated version + live API tester
├── start-all.bat      ← Windows: starts all services
└── start-all.sh       ← Mac/Linux: starts all services
```

---

> 💡 **Tip:** Open `README.html` locally in your browser while services are running for an animated version with a live API tester.

---

*EcoRoute — IT4020 Assignment 2 · SLIIT · 2026*  
*GitHub: [Nihara-D/ecoroute-smart-waste-management](https://github.com/Nihara-D/ecoroute-smart-waste-management)*
